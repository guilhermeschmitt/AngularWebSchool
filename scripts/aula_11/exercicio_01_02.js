angular.module('BeMEAN', ['ngAnimate'])
		...
		function ProfessorController(){
			...
			vm.professores = [{name: 'Dantas', aula:'Distribuida', idade:18, carga:120, edit:false}
							 ,{name:'Westphall', aula:'Redes', idade:29, carga:100, edit:false}
							 ,{name: 'Elder', aula:'Inteligencia Artificial', idade:15, carga:180, edit:false}
			];
